...
cd "$repo_root"
cargo about generate packaging/licenses/about.hbs \
    --config packaging/licenses/about.toml --workspace --locked --fail \
...
echo "==> refreshed docs/legal/THIRD_PARTY_LICENSES.md"
